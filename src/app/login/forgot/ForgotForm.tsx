...
export function ForgotForm() {
  ...
  if (state.submitted) {
    return (
      <div className="w-full max-w-[420px] mt-[10vh] text-center">
        <h1 className="font-heading font-bold text-2xl text-[var(--color-sage-deep)] m-0 mb-3">Check your email</h1>
  ...
  return (
    <div className="w-full max-w-[420px] mt-[10vh]">
      <h1 className="font-heading font-bold text-2xl text-[var(--color-sage-deep)] m-0 mb-1.5">Reset your password</h1>
      ...
      <Link href="/login" className="inline-block mt-5 text-[var(--color-sage)] font-bold text-sm no-underline hover:underline">
        &larr; Back to sign in
      </Link>
    </div>
  );
