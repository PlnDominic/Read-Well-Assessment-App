...
export function ResetPasswordForm() {
  ...
  if (linkError) {
    return (
      <div className="w-full max-w-[420px] mt-[10vh] text-center">
        <h1 className="font-heading font-bold text-2xl text-[var(--color-sage-deep)] m-0 mb-3">Link expired</h1>
        <p className="text-[var(--color-terracotta-dark)] text-sm mb-6">{linkError}</p>
        <a href="/login/forgot" className="text-[var(--color-sage)] font-bold text-sm no-underline hover:underline">
          Request a new link
        </a>
      </div>
    );
  ...
  if (done) {
    return (
      <div className="w-full max-w-[420px] mt-[10vh] text-center">
        <h1 className="font-heading font-bold text-2xl text-[var(--color-sage-deep)] m-0 mb-3">Password updated</h1>
  ...
  return (
    <div className="w-full max-w-[420px] mt-[10vh]">
      <h1 className="font-heading font-bold text-2xl text-[var(--color-sage-deep)] m-0 mb-1.5">Set a new password</h1>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <button
          type="submit"
          disabled={isPending}
          className="bg-[var(--color-sage)] text-white border-none rounded-full font-heading font-bold text-lg py-3.5 cursor-pointer disabled:opacity-60"
        >
