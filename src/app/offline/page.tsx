      ...
      <div className="w-full max-w-[460px] mt-[8vh] text-center">
        <div className="relative flex justify-center mb-6">
          <div
            ...
            aria-hidden
          />
          <div className="relative w-24 h-24 rounded-full bg-[var(--color-orange)] flex items-center justify-center shadow-[0_10px_24px_rgba(74,107,82,0.25)]">
        ...
        <div className="flex flex-col items-center gap-3">
          <Link
            href="/student/join"
            className="bg-[var(--color-orange)] text-white rounded-full font-heading font-bold text-lg px-10 py-4 no-underline shadow-[0_10px_24px_rgba(201,123,95,0.35)] transition-transform hover:-translate-y-0.5"
          >
            I&apos;m a Student
          </Link>
